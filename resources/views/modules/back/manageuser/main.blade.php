    ...
    <div class="container-fluid">
        ...
        <div class="table-responsive" col-lg-8>
            <div class="row justify-content-center mb-2">
                <div class="col-md-6">
                    <form action="/dashboard/manageuser">
                ...
                <tbody>
                    ...
                    <div>
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('dashboard/manageuser/update',$item->id) }}" class="badge bg-warning"><span data-feather="edit-3">Ubah</span></a>
                            </td>
                            <td><a href="{{ url ('/dashboard/manageuser/detele',$item->id) }}" class="badge bg-danger border-0 deleteUserByAdmin">Hapus</a></td>
                        </tr>
                    </div>
            ...
            <hr>
            <a href="/dashboard/manageuser/create" class="btn btn-primary mb-3">Tambah User</a>
            <hr>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <strong style="font-size: 30px;">Detail Informasi User</strong>
                </div>
