    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex mr-3 position-relative">
                    <a href="{{ route('carts.index') }}" class="nav-link">
                        <span class="position-absolute top-0 start-90 translate-middle badge rounded-pill bg-danger">
                            {{ $notif == 0 ? '0' : $notif }}
                        </span>
                        <!-- Tautan ke ikon keranjang belanja -->
                        <img src="/images/iconcart.png" class="block h-9 w-auto fill-current text-gray-800" />
                    </a>
                </div>
                @auth
